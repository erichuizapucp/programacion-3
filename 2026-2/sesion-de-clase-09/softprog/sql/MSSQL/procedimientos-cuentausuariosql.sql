...
IF OBJECT_ID('buscar_cuenta_usuario_por_user_name', 'P') IS NOT NULL
    DROP PROCEDURE buscar_cuenta_usuario_por_user_name;
GO
...
CREATE PROCEDURE buscar_cuenta_usuario_por_user_name
    @p_user_name NVARCHAR(50)
AS
BEGIN
