...
GO
IF OBJECT_ID('dbo.eliminar_lineas_por_orden_venta', 'P') IS NOT NULL DROP PROCEDURE dbo.eliminar_lineas_por_orden_venta;
GO
...
CREATE PROCEDURE dbo.eliminar_lineas_por_orden_venta
    @p_id_orden_venta INT
AS
BEGIN
