...
namespace PUCP.SoftProg.Negocio.BOImpl {
    public class OrdenVentaBOImpl : IOrdenVentaBO {
        ...
        public OrdenVenta Obtener(int id) {
            OrdenVenta ordenVenta = this.ordenVentaDAO.Leer(id);
            List<LineaOrdenVenta> lineas = this.lineaOrdenVentaDAO.LeerTodosPorOrden(id);
            ordenVenta.LineasOrdenVenta = lineas;
        ...
        public List<OrdenVenta> ListarPorCuenta(string cuenta) {
            return this.ordenVentaDAO.LeerOrdenesPorCuenta(cuenta);
        }
    }
}
