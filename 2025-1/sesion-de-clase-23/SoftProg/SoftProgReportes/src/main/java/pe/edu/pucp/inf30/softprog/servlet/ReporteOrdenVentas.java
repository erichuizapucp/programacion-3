 ...
 * @author eric
 */
@WebServlet(name = "ReporteOrdenVentas", urlPatterns = {"/reportes/ordenes"})
public class ReporteOrdenVentas extends HttpServlet {
    ...
    private final String SUB_REPORTE = 
            "reportes/DetalleOrdenVenta.jasper";
