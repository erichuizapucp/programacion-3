 ...
 * @author eric
 */
public class ComandoGuardarOrdenVenta extends ComandoBase implements IComandoTransaccional {
    public ComandoGuardarOrdenVenta(IOrdenVentaDAO ordenVentaDAO, ILineaOrdenVentaDAO lineaOrdenVentaDAO, Estado estado, OrdenVenta modelo) {
    ...
    public void ejecutar(Connection conexion) {
        ...
        if (estado == Estado.Nuevo) {
            int orderId = ordenVentaDao.insertar(ordenVenta, conexion);
