 ...
 * @author eric
 */
@WebService(serviceName = "EmpleadoWS", targetNamespace = "http://services.softprog.pucp.edu.pe/")
public class EmpleadoWS {
    ...
    public Empleado obtenerEmpleado(@WebParam(name = "id") int id) throws Exception {
    ...
    public void eliminarEmpleado(@WebParam(name = "id") int id) throws Exception {
        String url = this.urlBase + "/" + this.NOMBRE_RESOURCE + "/" + id;
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(url))
                .DELETE()
    ...
    public void guardarEmpleado(@WebParam(name = "empleado") Empleado empleado, @WebParam(name = "estado") Estado estado) throws Exception {
    ...
    public Empleado buscarEmpleadpPorDni(@WebParam(name = "dni") String dni) throws Exception {
