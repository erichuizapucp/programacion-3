...
namespace PUCP.Edu.Pe.SoftProg.Persistencia.DAOImpl.RRHH {
    public class CuentaUsuarioDAOImpl : BaseDAOImpl<CuentaUsuario>, ICuentaUsuarioDAO {
        ...
        protected override DbCommand CommandoInsertar(DbConnection conn, DbTransaction transaccion, CuentaUsuario cuentaUsuario) {
            DbCommand cmd = this.CommandoInsertar(conn, cuentaUsuario);
