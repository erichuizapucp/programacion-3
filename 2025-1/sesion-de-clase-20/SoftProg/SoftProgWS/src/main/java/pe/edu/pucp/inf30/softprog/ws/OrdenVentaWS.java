...
public class OrdenVentaWS {
    ...
    public List<OrdenVenta> listarOrdenesVenta() throws Exception {
        ...
        List<OrdenVenta> ordenes = mapper.readValue(json, new TypeReference<List<OrdenVenta>>() {});
        
        return ordenes;
    }
    
    @WebMethod(operationName = "obtenerOrdenVenta")
    public OrdenVenta obtenerOrdenVenta(@WebParam(name = "id") int id) throws Exception {
    ...
    public void eliminarOrdenVenta(@WebParam(name = "id") int id) throws Exception {
        String url = this.urlBase + "/" + this.NOMBRE_RECURSO + "/" + id;
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(url))
                .DELETE()
    ...
    public void guardarOrdenVenta(@WebParam(name = "ordenventa") OrdenVenta ordenVenta, @WebParam(name = "estado") Estado estado) throws Exception {
