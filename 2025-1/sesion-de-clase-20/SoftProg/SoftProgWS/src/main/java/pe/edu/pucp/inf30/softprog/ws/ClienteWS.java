...
public class ClienteWS {
    ...
    public Cliente obtenerCliente(@WebParam(name = "id") int id) throws Exception {
    ...
    public void eliminarCliente(@WebParam(name = "id") int id) throws Exception {
        String url = this.urlBase + "/" + this.NOMBRE_RESOURCE + "/" + id;
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(url))
                .DELETE()
    ...
    public void guardarCliente(@WebParam(name = "cliente") Cliente cliente, @WebParam(name = "estado") Estado estado) throws Exception {
    ...
    public Cliente buscarClientePorDni(@WebParam(name = "dni") String dni) throws Exception {
