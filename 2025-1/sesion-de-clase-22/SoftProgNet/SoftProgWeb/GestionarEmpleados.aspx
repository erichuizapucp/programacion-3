<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GestionarEmpleados.aspx.cs" Inherits="PUCP.Edu.Pe.SoftProg.Web.GestionarEmpleados" %>
...
<div class="container">
    <div class="card">
        ...
        <div class="card-footer">
            <asp:Button id="btnGuardar" runat="server" CssClass="float-end btn btn-primary" Text="Guardar" OnClick="guardar_empleado"/>
        </div>
    </div>
</div>
</asp:Content>
