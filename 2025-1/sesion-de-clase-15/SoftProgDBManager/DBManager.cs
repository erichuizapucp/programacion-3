...
namespace PUCP.Edu.Pe.SoftProg.Config {
    public class DBManager {
        ...
        private string CadenaConexion() {
            ...
            string encodedPassword = ConfigurationManager.AppSettings["db.password"];
            byte[] encodedPasswordBytes = Convert.FromBase64String(encodedPassword);
            this.password = Encoding.Default.GetString(encodedPasswordBytes);
            ...
            switch (this.providerName) {
                ...
                case "MySql.Data.MySqlClient":
                    cadenaConexion = $"Server={this.host};Port={this.puerto};Database={this.baseDatos};Uid={this.usuario};Pwd={this.password};SslMode=Required;";
                    break;
                default:
