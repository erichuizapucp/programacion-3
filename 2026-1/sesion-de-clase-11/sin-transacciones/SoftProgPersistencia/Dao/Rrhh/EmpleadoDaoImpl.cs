...
public class EmpleadoDaoImpl : PersonaBaseDao<Empleado>, IEmpleadoDao
{
    ...
    protected override Empleado MapearModelo(DbDataReader reader)
    {
        var modelo = new Empleado
        {
            ...
            Cargo = Enum.Parse<Cargo>(reader.GetString(reader.GetOrdinal("cargo"))),
            Sueldo = reader.GetDouble(reader.GetOrdinal("sueldo")),
            Activo = reader.GetBoolean(reader.GetOrdinal("activo")),
            Area = new AreaDaoImpl().Leer(reader.GetInt32(reader.GetOrdinal("idArea")))
        };
